...
class MOT:
    def __init__(self, size,
        ...
        self.detector  = jetson.inference.detectNet(CONFIG.NETWORK, CONFIG.CUSTOM_MODEL, CONFIG.DETECTION_THRESHOLD)
    ...
    def step(self, frame):
        ...
        if self.frame_count == 0:
            frame_cuda = jetson.utils.cudaToNumpy(frame) 
            detections = net.Detect(frame_cuda, overlay=CONFIG.OVERLAY)
